...
export default function AddProductButton() {
    ...
    const [ imagePreview, setImagePreview ] = useState('/next.svg' || null);
    ...
    const onSubmit = async (values: z.infer<typeof FormSchema>) => {
        ...
        const url = await fetch('http://localhost:3000/api/upload?productImage=true', {
            method: 'POST',
            body: formFile
        })
        .then((res) => res.json())
    ...
    return (
        ...
        <SheetTrigger asChild>
          <Button variant="outline"><Plus className="mr-1" size={20}/>Add Product</Button>
        </SheetTrigger>
        <SheetContent>
          <SheetHeader>
          ...
          <SheetFooter>
            <SheetClose asChild>
              <Button type="submit" onClick={handleAddProductClick}>Add Product</Button>
            </SheetClose>
          </SheetFooter>
        </SheetContent>
        <AlertDialog open={showAlert} onOpenChange={setShowAlert}>
            <AlertDialogContent>
            <AlertDialogHeader>
                <AlertDialogTitle>Happy with the product?</AlertDialogTitle>
                <AlertDialogDescription>
                    Confirming will add the product to the inventory.
                </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
